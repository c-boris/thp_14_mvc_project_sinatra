...
Maintenant si tu vas sur la page d'accueil de ton serveur en exécutant $ rackup -p 4567, tu devrais avoir cette nouvelle page, qui dit "depuis le dossier views".
